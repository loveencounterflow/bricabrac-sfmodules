...
class Dbric_std_base extends Dbric
  ...
  #---------------------------------------------------------------------------------------------------------
  @build: [
    SQL"""create view std_tables    as select * from sqlite_schema where type is 'table' order by name;"""
    SQL"""create view std_views     as select * from sqlite_schema where type is 'view' order by name;"""
    SQL"""create view std_relations as select * from sqlite_schema where type in ( 'table', 'view' ) order by name;"""
    SQL"""create view std_functions as select * from pragma_function_list() order by name;"""
    ]
