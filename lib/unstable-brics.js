    ...
    require_format_stack: function() {
      ...
      Format_stack = class Format_stack {
        ...
        format(error_or_stack) {
          ...
          console.debug('Ωbrics___4', Error.isError(error_or_stack));
          console.debug('Ωbrics___5', type_of(error_or_stack));
