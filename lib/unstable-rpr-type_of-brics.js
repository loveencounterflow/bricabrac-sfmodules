...
/* TAINT code duplication */
  ...
  demo_show = function() {
    ...
    debug('Ω___4', show);
    debug('Ω___5', show.state);
    debug('Ω___6', show(show.dent));
    debug('Ω___7', show.go_down());
    debug('Ω___8', show(show.dent));
    echo();
    echo('Ω___9', '————————————————————————————————————————————————————————————————');
    echo('Ω__10', show(v_1 = "foo 'bar'"));
    echo('Ω__11', '————————————————————————————————————————————————————————————————');
    echo('Ω__12', show(v_2 = {}));
    echo('Ω__13', '————————————————————————————————————————————————————————————————');
    echo('Ω__14', show(v_3 = {
    ...
    echo('Ω__16', show(v_4 = []));
    echo('Ω__17', '————————————————————————————————————————————————————————————————');
    echo('Ω__18', show(v_5 = ['some', 'words', 'to', 'show', 1, -1, false]));
    echo('Ω__19', '————————————————————————————————————————————————————————————————');
    echo('Ω__20', show(v_6 = new Map([['kong', 108], ['low', 923], [971, 'word'], [true, '+1'], ['a b c', false]])));
    echo('Ω__21', '————————————————————————————————————————————————————————————————');
    echo('Ω__22', show(v_7 = new Set(['some', 'words', true, false, null, void 0, 3.1415926, 0/0])));
    echo('Ω__23', '————————————————————————————————————————————————————————————————');
    echo('Ω__24', show(v_8 = /abc[de]/));
    echo('Ω__25', '————————————————————————————————————————————————————————————————');
    echo('Ω__26', show(v_9 = Buffer.from('abcäöü')));
    echo('Ω__27', '————————————————————————————————————————————————————————————————');
    echo('Ω__28', show(v_10 = {v_1, v_2, v_3, v_4, v_5, v_6, v_7, v_8, v_9})); // v_10, v_11, v_12, v_13, v_14, }
    v_10.v_10 = v_10;
    echo('Ω__29', '————————————————————————————————————————————————————————————————');
    echo('Ω__30', rpr(v_10));
    echo('Ω__31', show(v_10 = {v_1, v_2, v_3, v_4, v_5, v_6, v_7, v_8, v_9, v_10})); // v_10, v_11, v_12, v_13, v_14, }
    echo('Ω__32', '————————————————————————————————————————————————————————————————');
    a = ['a'];
    b = ['b', a];
    echo('Ω__33', rpr(b));
