            ...
            for (_ in ref) {
              ...
              try {
                ...
                if (!RegExp(`no\\s+such\\s+${type}:`).test(error.message)) {
                  warn(`Ωdbric___6 ignored error: ${error.message}`);
                }
              }
            }
...
//...................................................................................................
            for (i = 0, len = build_statements_list.length; i < len; i++) {
              ...
              if ((ref = (type = type_of(build_statements))) !== 'undefined' && ref !== 'null' && ref !== 'list') {
                throw new Error(`Ωdbric___7 expected an optional list for ${clasz.name}.build, got a ${type}`);
              }
...
//.................................................................................................
          ...
          _get_is_ready() {
            ...
            if (error_count !== 0) {
              ...
              throw new Error(`Ωdbric___8 ${error_count} out of ${statement_count} build statement(s) could not be parsed: ${rpr_string(messages)}`);
            }
            //...................................................................................................
          ...
          _prepare_statements() {
            ...
            //       null
            //     else
            //       throw new Error "Ωnql___9 unable to parse statement name #{rpr_string name}"
            // #   @[ name ] = @prepare sql
            clasz = this.constructor;
...
//...............................................................................................
          ...
          create_aggregate_function(cfg) {
            ...
            if ((type_of(this.db.aggregate)) !== 'function') {
              throw new Error(`Ωdbric__14 DB adapter class ${rpr_string(this.db.constructor.name)} does not provide user-defined aggregate functions`);
            }
          ...
          create_window_function(cfg) {
            ...
            if ((type_of(this.db.aggregate)) !== 'function') {
              throw new Error(`Ωdbric__16 DB adapter class ${rpr_string(this.db.constructor.name)} does not provide user-defined window functions`);
            }
          ...
          create_table_function(cfg) {
            ...
            if ((type_of(this.db.table)) !== 'function') {
              throw new Error(`Ωdbric__18 DB adapter class ${rpr_string(this.db.constructor.name)} does not provide table-valued user-defined functions`);
            }
          ...
          create_virtual_table(cfg) {
            ...
            if ((type_of(this.db.table)) !== 'function') {
              throw new Error(`Ωdbric__20 DB adapter class ${rpr_string(this.db.constructor.name)} does not provide user-defined virtual tables`);
            }
