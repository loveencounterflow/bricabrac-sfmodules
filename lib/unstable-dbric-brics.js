...
//...............................................................................................
          ...
          create_table_function(cfg) {
            ...
            if ((type_of(this.db.table)) !== 'function') {
              throw new Error(`Ωdbric__16 DB adapter class ${rpr_string(this.db.constructor.name)} does not provide table-valued user-defined functions`);
            }
          ...
          create_virtual_table(cfg) {
            ...
            if ((type_of(this.db.table)) !== 'function') {
              throw new Error(`Ωdbric__18 DB adapter class ${rpr_string(this.db.constructor.name)} does not provide user-defined virtual tables`);
            }
